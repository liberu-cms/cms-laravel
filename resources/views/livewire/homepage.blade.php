    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="mt-5 sm:mt-10 lg:mt-0 lg:col-span-5">
            ...
            <div class="space-y-2 md:space-y-4">
                <h2 class="font-bold text-3xl lg:text-4xl text-gray-500 ">
            ...
            <ul class="space-y-2 sm:space-y-4">
                ...
                <div class="grow">
                    ...
                    - software solutions that ensure uptime and performance,
                    </span>
                </div>
                </li>
                ...
                <div class="grow">
                    <span class="text-sm sm:text-base text-gray-500 dark:text-neutral-500">
                        <span class="font-bold">Scalability</span> 
                    ...
                    <div class="grow">
                        <span class="text-sm sm:text-base text-gray-500 dark:text-neutral-500">
                            <span class="text-sm sm:text-base text-gray-500 dark:text-neutral-500">
                                ...
                                - Receive dedicated support and regular updates 
                            </span>
                        </span>
                    </div>
                </li>
...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-16 mx-auto">
        ...
        <div class="max-w-md">
            <h2 class="text-2xl font-bold md:text-3xl md:leading-tight">Subscribe</h2>
        ...
        <form>
            ...
            <div class="flex flex-col items-center gap-2 sm:flex-row sm:gap-3">
                ...
                <input type="text" id="hero-input" name="hero-input" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" placeholder="Enter your email">
                </div>
